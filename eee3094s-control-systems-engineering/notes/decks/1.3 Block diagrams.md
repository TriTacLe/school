...
\begin{tikzpicture}
\node (r) at (0,0) {$r(s)$};
\node[draw, circle, inner sep=2pt] (sum) at (1.7,0) {$\Sigma$};
\node[draw, minimum width=1.5cm, minimum height=0.9cm] (k) at (4.2,0) {$K(s)$};
\node[draw, minimum width=1.5cm, minimum height=0.9cm] (p) at (7.2,0) {$P(s)$};
\node (y) at (9.7,0) {$y(s)$};
\node[draw, minimum width=1.5cm, minimum height=0.9cm] (h) at (5.4,-2.2) {$H(s)$};
\coordinate (t) at (8.7,0);
\draw[->] (r) -- (sum);
\draw[->] (sum) -- (k) node[midway, above] {$e(s)$};
\draw[->] (k) -- (p) node[midway, above] {$u(s)$};
\draw[->] (p) -- (y);
\node at (1.35,0.35) {$+$};
\node at (2.05,-0.35) {$-$};
\fill (t) circle (1.8pt);
...
\node (r) at (0,0) {$r(s)$};
\node[draw, circle, inner sep=2pt] (sum) at (1.7,0) {$\Sigma$};
\node[draw, minimum width=1.5cm, minimum height=0.9cm] (g) at (4.4,0) {$G(s)$};
\node (y) at (7.2,0) {$y(s)$};
\node[draw, minimum width=1.5cm, minimum height=0.9cm] (h) at (4.4,-2.2) {$H(s)$};
\coordinate (t) at (6.2,0);
\draw[->] (r) -- (sum);
\draw[->] (sum) -- (g) node[midway, above] {$e(s)$};
\draw[->] (g) -- (y);
\node at (1.35,0.35) {$+$};
\node at (2.05,-0.35) {$-$};
\fill (t) circle (1.8pt);
