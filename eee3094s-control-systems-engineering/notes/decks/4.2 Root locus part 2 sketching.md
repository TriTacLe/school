...
*Amathuba: Module 2, Chapter 1: Closed Loop Systems - Poles and the Root Locus > Notes > `notes+4_2+root+locus+part+2+sketching.pdf`*  
*Local deck: `02 Modules/Module 2, Chapter 1 - Closed Loop Systems, Poles and the Root Locus/4.2 Root locus part 2 sketching.pdf`*
